...
checkpoint_fname = 'checkpoints/ch06_06_01.hdf5'
log_fname = 'logs/ch06_06_01.log'
output_fname='data/ch06_06_01_samplers.txt'
batch_size = 16
output_dim=128
num_epochs=1000
...
cb_logger = CSVLogger(log_fname,append=True)
