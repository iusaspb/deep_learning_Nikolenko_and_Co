...
fig.canvas.set_window_title('Рис. 5.10. Пример работы разреженного автокодировщика: а — исходные изображения; б — реконструированные; в — восстановленные из «обрезанного» скрытого слоя')
for i in range(nrows*ncols):
    ...
    i_col += ncols + 1
    axs[i_row][i_col].imshow(np.reshape(noised_visible_val[i] * 255, image_shape))
plt.tight_layout()
plt.show()
