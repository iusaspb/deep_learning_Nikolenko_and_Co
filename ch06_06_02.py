#
# LSTM c тремя слоями с skip layer connection
#
import os
import csv
import numpy as np
...
checkpoint_fname = 'checkpoints/ch06_06_02.hdf5'
log_fname = 'logs/ch06_06_02.log'
output_fname='data/ch06_06_02_samplers.txt'
batch_size = 16
output_dim=128
num_epochs=1000
